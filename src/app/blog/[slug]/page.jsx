...
<div className="lg:w-8/12 blog_detail w-full">
    <Blog_detail_page params={params} />
    </div> 
    <div className="lg:w-4/12  lg:sticky top-[65px] w-full mt-2">

      
<div className={`lg:sticky top-[70px] max-h-[800px] lg:h-[calc(100vh-80px)] rounded-3xl shadow-[0_0px_60px_-15px_rgba(0,0,0,0.5)]       lg:ml-5 lg:overflow-y-auto scrollbar-hide`}>
  <div className="h-full contact_blog_scroll_bar">
   <p className="sticky  pt-3 bg-white px-5 font-black rounded-3xl text-md top-0  z-10 text-[#1a1a18]">
    VEHICLE REGISTRATION*
        ...
        <div className=" rounded-3xl  mt-[-30]  w-full flex justify-center items-center scrollbar-hide">
