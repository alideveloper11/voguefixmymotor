...
export default function Contact() {
  return (
    <div className="flex relative py-5 lg:py-15 bg-white flex-wrap leading-7 tracking-[0.04em] w-full">
      <div className="relative mx-5 bg-[#f2f2f2] px-5 pb-5 rounded-xl shadow-[0_0_5px_#7c7d7d] lg:mx-12 lg:mx-15 flex flex-wrap">
        ...
        <div className="w-full flex flex-wrap md:w-1/2 px-2">
          <div className="p-4 mt-5 px-7 w-full lg:px-3 lg:mx-4 bg-[url('/51445d42-1fc6-4c67-a0c5-efad007bb5c2.png')] bg-cover bg-center bg-no-repeat rounded-xl shadow-[0_0_5px_#7c7d7d]">
            ...
            <div>
              ...
              <p className="text-base leading-7 tracking-[0.015em] text-black font-normal">
                Have a question about your vehicle or want to book a repair?
                Contact our team at Vogue Fix My Motor in Grays, Essex. We
                service all makes and models across Essex and surrounding areas.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 mt-5 px-7 lg:px-3 w-full lg:mx-4 bg-[white] rounded-xl shadow-[0_0_5px_#7c7d7d]">
            <div className="flex flex-wrap">
              <div className="w-full md:w-1/2">
                <div className="m-1">
                  ...
                  <p className="font-bold">
                    ...
                    >
                      Unit 1D Hedley Ave Grays RM20 4EL United Kingdom
                    </Link>
                  </p>
                </div>
              </div>
              <div className="w-full md:w-1/2">
                <div className="m-2">
                  ...
                  <p className="font-bold">
                    <Link href="tel:+01375531355">01375 531355</Link>
                  </p>
                  <p className="text-[#028D53] text-[12px] font-bold">EMAIL:</p>
                  <p className="flex break-all font-bold text-sm md:text-xs lg:text-sm">
            ...
            <div className="w-full">
              <div className="m-2">
                <p className="text-[#028D53] underline pt-1 font-bold">
                  OPENING HOURS
                </p>
                <div className="font-bold">
                  Monday - Friday:
                  <span className="text-[20px] inline"> 9:00 AM - 6:00 PM</span>
                </div>
                <div className="font-bold">
                  Saturday:
                  <span className="text-[20px] inline"> 7:00 AM - 1:00 PM</span>
                </div>
                <div className="font-bold">
                  Sunday: <span className="text-[red] inline">Closed</span>
                </div>
              </div>
            </div>
