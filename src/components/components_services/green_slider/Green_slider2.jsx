"use client";
import slides from "@/lib/services_data/green_slider2";
        ...
        <div className="flex w-full flex-wrap ">
            ...
            <div className="w-full md:w-12/24">
                <div  style={{width:"100%", height:"650px"}}>
                    <img src="/vogue fix my motor image 14.jpg"  className="w-full object-cover" style={{width:"100%", height:"100%"}} alt="slider_section_image" />
                </div>
            </div>
        </div>
  );
